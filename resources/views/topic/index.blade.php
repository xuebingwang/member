...
@section('content')
    <div class="page clearfix">
        <ol class="breadcrumb breadcrumb-small">
            <li>后台首页</li>
            <li>用户中心</li>
            <li><a href="{{ url('admin/topics') }}">用户列表</a></li>
        </ol>
        <div class="page-wrap">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="panel panel-lined clearfix mb30">
                        <div class="panel-heading mb20">
                            <i>数据管理</i>
                            <a href="{{ url('admin/topics/create') }}"><i class="fa fa-plus"></i>添加</a>
                        </div>
                        <table class="table table-hover">
                            ...
                            @foreach($lists as $list)
                                <tr>
                                    ...
                                    <td>{{ $list->title }}</td>
                                    <td>{{ str_limit($list->body) }}</td>
                                    <td>{{ $list->created_at }}</td>
                                    <td>
                                        <form action="{{ url('admin/topics/' . $list->id) }}" method="post" style="display: inline;">
                                            <input name="_method" type="hidden" value="delete">
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            <div class="btn-group">
                                                <a href="{{ url('admin/topics/' . $list->id . '/edit') }}" class="btn btn-primary btn-xs"><i class="fa fa-search-plus"></i>编辑</a>
